    ...
    <div class="row border rounded-5 p-3 bg-white shadow box-area">
      ...
      <div class="col-md-6 rounded-4 d-flex justify-content-center align-items-center flex-column left-box"
        ...
        <div class="featured-image mb-4">
          <img src="images/logo-hd.webp" class="img-fluid" style="width: 250px" />
        </div>
        <p class="text-white fs-2" style="font-family: 'Poppins', sans-serif; font-weight: 600">
          Rumah Sakit Haji
        </p>
      </div>
      ...
      <div class="col-md-6 right-box">
        <div class="row align-items-center">
          ...
          <!-- Display general error messages, including lockout messages -->
          @if ($errors->has('email'))
          ...
          <form method="POST" action="{{ route('login') }}">
            ...
            <div class="input-group mb-3">
              <input id="email" type="email"
                class="form-control form-control-lg bg-light fs-6 @error('email') is-invalid @enderror" name="email"
