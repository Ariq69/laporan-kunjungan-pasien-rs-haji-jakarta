...
<div class="container-fluid">
            <div class="row align-items-start">
                ...
                <div class="col">
                    <div class="card">
                        <div class="card-body">
                        <h5 class="card-title">Jumlah Aset Inventaris</h5>
                            <form method="post" action="{{ url('/tech/jumlah_aset_inventaris') }}">
                                @csrf
                                <div class="row">
                                    <div class="col">
                                ...
                                <div class="col">
                                    <label for="aset">Jenis Jumlah Inventaris</label>
                                    <select class="form-control" id="aset" name="aset">
                                        <option name="peruang" value="peruang">Per-Ruang</option>
                                        <option name="perkategori" value="perkategori">Per-Status</option>
                                        <option name="permerk" value="permerk">Per-Merk</option>
                                        <option name="perjenis" value="perjenis">Per-Jenis</option>
                                        <option name="perprodusen" value="perprodusen">Per-Produsen</option>
