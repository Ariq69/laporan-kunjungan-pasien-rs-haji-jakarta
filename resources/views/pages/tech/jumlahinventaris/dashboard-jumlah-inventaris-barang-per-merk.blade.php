...
<div class="row">
                                ...
                                <nav>
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active">
                                            Jumlah Inventaris Barang Per-merk
                                        </li>
                                    </ol>
                                </nav>
                            </div>
            ...
            <div class="row align-items-start">
                ...
                <div class="col">
                    <div class="card">
                        <div class="card-body">
                        <h5 class="card-title">Jumlah Inventaris Barang Per-Merk</h5>
                            <form method="post" action="{{ url('/tech/jumlah_inventaris_barang_per_merk') }}">
                                @csrf
                                <div class="row">
                                    <div class="col">
