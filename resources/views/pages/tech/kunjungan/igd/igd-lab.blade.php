...
<div class="container-fluid">
    <div class="row align-items-start">
                            ...
                            <nav>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item">
                                        <a href="{{ route('igd') }}">Jenis Penunjang IGD</a>
                                    </li>
                                    <li class="breadcrumb-item active">
                                        Pasien Laboratorium dari IGD
                                    </li>
                                </ol>
                            </nav>
                        </div>
        ...
        <div class="col">
            <div class="card">
                <div class="card-body">
                <h5 class="card-title">Pasien Laboratorium dari IGD</h5>
                    <form method="post" action="{{ url('/tech/igd-lab') }}">
                        @csrf
                        <div class="row">
                            <div class="col">
