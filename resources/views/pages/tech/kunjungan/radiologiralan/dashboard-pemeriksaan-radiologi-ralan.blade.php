        ...
        <div class="container-fluid">
            <div class="row align-items-start">
                ...
                <div class="col">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Jumlah Pasien Permintaan Radiologi</h5>
...
<script>
    ...
    radSelect.addEventListener('change', function() {
        localStorage.setItem('selectedrad', radSelect.value);
    });
...
(function($) {
    $(document).ready(function() {
        ...
        BarChartSumRadioRalan.ChartData(ctx, 'bar', labels, data);
    });
