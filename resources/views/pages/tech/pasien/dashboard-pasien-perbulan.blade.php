        ...
        <div class="container-fluid">
            <div class="row align-items-start">
                ...
                <div class="col">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Jumlah Pasien Per Status</h5>
                                        ...
                                        <div class="col">
                                            ...
                                            <select name="status" id="status" class="form-control">
                                                @forEach ($status as $stts)
                                                    <option value="{{ $stts->stts_daftar }}">{{ $stts->stts_daftar }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="col">
...
<script>
    ...
    var sttsSelect = document.getElementById('status');
    ...
    var storedStts = localStorage.getItem('selectedStts');
    ...
    sttsSelect.addEventListener('change', function() {
        localStorage.setItem('selectedStts', sttsSelect.value);
    });
</script>
<script>
