                                        ...
                                        <div class="col">
                                            ...
                                            <select class="form-control" id="jk" name="jk">
                                                @foreach ($jk as $jenisKelamin)
                                                    <option value="{{ $jenisKelamin->jk }}">{{ $jenisKelamin->jk }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="col">
...
<script>
    ...
    var storedJk = localStorage.getItem('selectedJk');
    ...
    jkSelect.addEventListener('change', function() {
        localStorage.setItem('selectedJk', jkSelect.value);
    });
</script>
